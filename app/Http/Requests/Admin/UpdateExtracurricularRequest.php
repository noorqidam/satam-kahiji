...
class UpdateExtracurricularRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => 'required|string|max:255|unique:extracurriculars,name,' . $extracurricularId,
            'description' => 'nullable|string|max:2000',
            'photo' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:2048',
            'remove_photo' => 'nullable|string|in:true,false',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'remove_photo.string' => 'Remove photo flag must be a string.',
            'remove_photo.in' => 'Remove photo flag must be either "true" or "false".',
        ];
    }
    ...
    /**
     * Get processed data after validation.
     */
    ...
    {
        return $this->filled('remove_photo') && $this->remove_photo === 'true';
    }
