...
return new class extends Migration
{
    ...
    {
        // Check if we're using SQLite or PostgreSQL for different approaches
        if (DB::getDriverName() === 'sqlite') {
            // SQLite approach: Just add the column if not exists
            // Column reordering is less important for testing
            if (!Schema::hasColumn('students', 'homeroom_teacher_id')) {
            ...
            // PostgreSQL approach: recreate table to change column order
            DB::statement('
